...
/*
Retrieve a list of all presidents sorted by the number field (number 1 first, number 46 last)
...
const exercise = async () => {
  ...
  try {
    ...
    // ------ Add solution below ------
    // --------------------------------
    // const response = await President.find().sort('number')
    const response = await President.find().sort({ number: 1 })
