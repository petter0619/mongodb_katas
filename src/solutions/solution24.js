...
/*
Retrieve the name and number all Democrat presidents sorted by the number field in descending order
...
const exercise = async () => {
  ...
  try {
    ...
    // ------ Add solution below ------
    // --------------------------------
    const response = await President.find({ party: 'Democrat' }).sort({ number: -1 }).select('name number')
